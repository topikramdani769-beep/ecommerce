            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('admin.products.show', $product->id)}}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-warning text-dark" onclick="return confirm('Apakah anda yakin')">Delete</button>
                            </form>
                    </td>
                </tr>
                @empty
