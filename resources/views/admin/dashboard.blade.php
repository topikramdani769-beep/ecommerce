            ...
            <div class="card-body">
                <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                    <div class="mb-3 mb-sm-0">
                        <h5 class="card-title fw-semibold">Penjualan Perbulan</h5>
                    </div>
                    <div>
                        <select class="form-select">
                            ...
                            <option value="4">Jully 2025</option>
                            <option value="4">Agustus 2025</option>
                            <option value="4">September 2025</option>
                            <option value="4">Oktober 2025</option>
                            <option value="4">November 2025</option>
                            <option value="4">Desember 2025</option>
                        </select>
                    </div>
                </div>
                <div id="chart"></div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card overflow-hidden">
                    <div class="card-body p-4">
                        <h5 class="card-title mb-9 fw-semibold">Rincian Tahunan</h5>
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h4 class="fw-semibold mb-3">Rp 100.000.000</h4>
                    ...
                    <div class="card-body">
                        <div class="row alig n-items-start">
                            <div class="col-8">
                                ...
                                <h4 class="fw-semibold mb-3">Rp 18.000.000</h4>
